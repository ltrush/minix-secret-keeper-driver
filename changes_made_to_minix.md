...
3) I created driver source directory /usr/src/drivers/secret and imported my files using tar.
4) I added #include <sys/ioc_secret.h> /* 'K' */ to /usr/src/include/sys/ioctl.h
...
8) Finally I ran make in /usr/src